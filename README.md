...
1. Clone the repository
   ```bash
   git clone https://github.com/pranamiraj083-ship-it/data_digger_project.git
   cd Data_Digger
   ```
...
*rajkumar*
🔗 [GitHub Repository](https://github.com/pranamiraj083-ship-it/data_digger_project.git)
